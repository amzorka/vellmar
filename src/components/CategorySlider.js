...
const CategorySlider = () => {
  ...
  const categories = [
    ...
    { name: "ОТДЕЛОЧНЫЕ МАТЕРИАЛЫ", image: finishing, link: "/catalog/finishing" },
    { name: "ИНЖЕНЕРНАЯ САНТЕХНИКА", image: plumbing, link: "/catalog/plumbing" },
    { name: "ЭЛЕКТРОТОВАРЫ", image: electrogoods, link: "/catalog/electrogoods" },
  ...
  return (
    <div className="category-slider-container">
      ...
      <div className="slider-wrapper">
        ...
        >
          <img src=
          {ArrowLeft} alt='arrow' style={{width: '20px'}}>
          </img>
        </button>
        ...
        > <img src=
          {ArrowRight} alt='arrow' style={{width: '20px'}}>
          </img>
        </button>
      </div>
    </div>
