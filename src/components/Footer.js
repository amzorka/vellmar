  ...
  return (
    ...
    <div className="footer__contact">
        ...
        <div className="footer__contacts">
          ...
          Юридический адрес: 117342, г. Москва,<br /> вн.тер.г. муниципальный округ Коньково,<br /> ул. Обручева, д. 52, стр. 3<br /> пн-сб: 8:00-20:00. вс: 09:00-19:00
            </div>
            <div className="footer__contact-item" style={{marginTop: '30px', color: '#767676'}}>
